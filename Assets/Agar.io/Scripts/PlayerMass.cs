...
public class PlayerMass : MonoBehaviour
{
    ...
    public void AddMass(GameObject MassObject)
    {
        ...
        MassObject.transform.SetParent(UIController.instance.playerCloneParent.transform);
    }
    ...
    public void RemoveMass(GameObject MassObject)
    {
        ...
        MassObject.transform.SetParent(UIController.instance.PoolMangerParent.transform);
    }
